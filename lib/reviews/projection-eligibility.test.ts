...
test("v5/v6/v7 backward compatibilityを保ち、現行v8も投影対象", () => {
  assert.equal(PROJECTABLE_REVIEW_PROMPT_VERSION, "integrated-review-v8");
  assert.equal(PROJECTABLE_REVIEW_PROMPT_VERSION, INTEGRATED_REVIEW_PROMPT_V8);
